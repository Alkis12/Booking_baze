...
namespace baze_booking {
    ...
    public partial class BookingDataSet : global::System.Data.DataSet {
        ...
        public partial class LogInDataTable : global::System.Data.TypedTableBase<LogInRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public LogInRow AddLogInRow(int email, int password) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public LogInRow FindByemail(int email) {
        ...
        public partial class LogInRow : global::System.Data.DataRow {
            ...
            public int email {
                get {
                    return ((int)(this[this.tableLogIn.emailColumn]));
                }
                set {
...
namespace baze_booking.BookingDataSetTableAdapters {
    ...
    public partial class LogInTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[LogIn] WHERE (([email] = @Original_email) AND ([password] = @O" +
                "riginal_password))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[LogIn] ([email], [password]) VALUES (@email, @password);\r\nSELE" +
                "CT email, password FROM LogIn WHERE (email = @email)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[LogIn] SET [email] = @email, [password] = @password WHERE (([email]" +
                " = @Original_email) AND ([password] = @Original_password));\r\nSELECT email, passw" +
                "ord FROM LogIn WHERE (email = @email)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::baze_booking.Properties.Settings.Default.BookingConnectionString;
        }
        ...
        public virtual int Fill(BookingDataSet.LogInDataTable dataTable) {
        ...
        public virtual BookingDataSet.LogInDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BookingDataSet.LogInDataTable dataTable = new BookingDataSet.LogInDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BookingDataSet.LogInDataTable dataTable) {
        ...
        public virtual int Delete(int Original_email, int Original_password) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_email));
        ...
        public virtual int Insert(int email, int password) {
        ...
        public virtual int Update(int email, int password, int Original_email, int Original_password) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(email));
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(password));
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(Original_email));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int password, int Original_email, int Original_password) {
